!function(e) {
    ...
    function v(e, t) {
        ...
        f.st.callbacks[e] && f.st.callbacks[e].apply(f, p.isArray(t) ? t : [t]))
    }
    function m(e) {
        return e === t && f.currTemplate.closeBtn || (f.currTemplate.closeBtn = p(f.st.closeMarkup.replace("%title%", f.st.tClose)),
        t = e),
        f.currTemplate.closeBtn
    }
    function i() {
        p.magnificPopup.instance || ((f = new e).init(),
        p.magnificPopup.instance = f)
    }
    var f, a, _, o, h, t, c = "Close", u = "BeforeClose", g = "MarkupParse", n = "mfp", y = "." + n, b = "mfp-ready", r = "mfp-removing", s = !!window.jQuery, k = p(window);
    e.prototype = {
        constructor: e,
        init: function() {
        ...
        open: function(e) {
            ...
            if (!f.isOpen) {
                ...
                f.bgOverlay || (f.bgOverlay = d("bg").on("click" + y, function() {
                    f.close()
                }),
                ...
                v("BeforeOpen"),
                f.st.showCloseBtn && (f.st.closeBtnInside ? (l(g, function(e, t, n, a) {
                    n.close_replaceWith = m(a.type)
                }),
                h += " mfp-close-btn-in") : f.wrap.append(m())),
                ...
                setTimeout(function() {
                    f.content ? (f._addClassToMFP(b),
                    f._setFocus()) : f.bgOverlay.addClass(b),
        ...
        updateItemHTML: function() {
            ...
            var t = e.type;
            if (v("BeforeChange", [f.currItem ? f.currItem.type : "", t]),
            f.currItem = e,
            !f.currTemplate[t]) {
                var n = !!f.st[t] && f.st[t].markup;
                v("FirstMarkupParse", n),
                f.currTemplate[t] = !n || p(n)
            }
        ...
        appendContent: function(e, t) {
            (f.content = e) ? f.st.showCloseBtn && f.st.closeBtnInside && !0 === f.currTemplate[t] ? f.content.find(".mfp-close").length || f.content.append(m()) : f.content = e : f.content = "",
            v("BeforeAppend"),
        ...
        parseEl: function(e) {
            ...
            return n.type = t || f.st.type || "inline",
            n.index = e,
            n.parsed = !0,
            f.items[e] = n,
            v("ElementParse", n),
        ...
        addGroup: function(t, n) {
            ...
            (n = n || {}).mainEl = t,
            n.items ? (n.isObj = !0,
            t.off(a).on(a, e)) : (n.isObj = !1,
            n.delegate ? t.off(a).on(a, n.delegate, e) : (n.items = t).off(a).on(a, e))
        },
        ...
        _checkIfClose: function(e) {
            if (!p(e).hasClass("mfp-prevent-close")) {
                ...
                if (t && n)
                    return !0;
                if (!f.content || p(e).hasClass("mfp-close") || f.preloader && e === f.preloader[0])
                    return !0;
                if (e === f.content[0] || p.contains(f.content[0], e)) {
                    if (t)
                        return !0
                } else if (n && p.contains(document, e))
                    return !0;
                return !1
            }
        },
    ...
    p.fn.magnificPopup = function(e) {
        ...
        if ("string" == typeof e)
            if ("open" === e) {
                var n, a = s ? t.data("magnificPopup") : t[0].magnificPopup, o = parseInt(arguments[1], 10) || 0;
                n = a.items ? a.items[o] : (n = t,
            ...
            getInline: function(e, t) {
                ...
                e.src) {
                    ...
                    if (a.length) {
                        ...
                        o && o.tagName && (x || (w = n.hiddenClass,
                        x = d(w),
                        w = "mfp-" + w),
                        q = a.after(x).detach().removeClass(w)),
                        f.updateStatus("ready")
                    } else
                        f.updateStatus("error", n.tNotFound),
                        a = p("<div>");
    ...
    p.magnificPopup.registerModule("zoom", {
        ...
        proto: {
            ...
            _getOffset: function(e) {
                var t, n = (t = e ? f.currItem.img : f.st.zoom.opener(f.currItem.el || f.currItem)).offset(), a = parseInt(t.css("padding-top"), 10), o = parseInt(t.css("padding-bottom"), 10);
                ...
                O ? i["-moz-transform"] = i.transform = "translate(" + n.left + "px," + n.top + "px)" : (i.left = n.left,
                i.top = n.top),
                i
            }
        }
...
function(v) {
    v(document).ready(function() {
        var c = {
            set: function(e, t, n) {
                var a, o, i, r, s;
                r = n ? ((i = new Date).setTime(i.getTime() + 24 * n * 60 * 60 * 1e3),
                "; expires=" + i.toGMTString()) : "",
                1 === (s = location.host).split(".").length ? document.cookie = e + "=" + t + r + "; path=/" : ((o = s.split(".")).shift(),
                a = "." + o.join("."),
                document.cookie = e + "=" + t + r + "; path=/; domain=" + a,
                null != c.get(e) && c.get(e) == t || (a = "." + s,
                document.cookie = e + "=" + t + r + "; path=/; domain=" + a))
            },
            get: function(e) {
        ...
        function p(e) {
            var t = v(".devvn_prod_variable .cart", e).data("product_variations")
              ...
              , o = total = ship = 0;
            (v("#enable_ship", e).val() || 0) && 0 < v(".popup_quickbuy_shipping_calc", e).length && 0 < v('.popup_quickbuy_shipping_calc input[name="shipping_method[0]"]', e).length && (ship = parseInt(v('.popup_quickbuy_shipping_calc input[name="shipping_method[0]"]:checked', e).data("cost")),
            ship || 1 != v('.popup_quickbuy_shipping_calc input[name="shipping_method[0]"]', e).length || (ship = parseInt(v('.popup_quickbuy_shipping_calc input[name="shipping_method[0]"]', e).data("cost")))),
            t ? v(t).each(function(e, t) {
            ...
            total = o * n + ship - i,
            v(".popup_quickbuy_total_calc", e).html(l(total.toFixed(0), 0, "", ".") + " " + devvn_quickbuy_array.currency_format),
        ...
        function l(e, t, n, a) {
            ...
            var o, i, r, s = isFinite(+e) ? +e : 0, c = isFinite(+t) ? Math.abs(t) : 0, u = void 0 === a ? "," : a, p = void 0 === n ? "." : n, l = "";
            return 3 < (l = (c ? (o = s,
            i = c,
            r = Math.pow(10, i),
            "" + Math.round(o * r) / r) : "" + Math.round(s)).split("."))[0].length && (l[0] = l[0].replace(/\B(?=(?:\d{3})+(?!\d))/g, u)),
            (l[1] || "").length < c && (l[1] = l[1] || "",
            l[1] += new Array(c - l[1].length + 1).join("0")),
            l.join(p)
        }
        function i() {
            0 < v("body .devvn_prod_variable").length && 0 == v("body .devvn_prod_variable .quantity.buttons_added .screen-reader-text").length && v("body .devvn_prod_variable .quantity.buttons_added").append('<label class="screen-reader-text">' + devvn_quickbuy_array.qty_text + "</label>"),
            v("body .devvn-popup-quickbuy").each(function() {
                ...
                e.validate({
                    rules: {
                        ...
                        "customer-phone": {
                            required: {
                                depends: function() {
                                    return v(this).val(v.trim(v(this).val())),
                                    !0
                                }
                            },
                            vietnamphone: !0
                ...
                if (0 < v("#devvn_city", o).length) {
                    var r = !1
                      ...
                      , c = 0;
                    0 < v('button.single_add_to_cart_button[name="add-to-cart"]', o).length && (c = parseInt(v('button.single_add_to_cart_button[name="add-to-cart"]', o).val())),
                    v("#devvn_city", o).on("change", function(e) {
                        ...
                        if ((t = t || v("#devvn_city option:selected", o).val()) && !r) {
                            ...
                            v.ajax({
                                ...
                                success: function(e) {
                                    if (v("#devvn_district", o).html(""),
                                    v("#devvn_ward", o).html('<option value="">Xã/phường</option>'),
                                    e.success) {
                                    ...
                                    r = !1,
                                    v(".popup-customer-info", o).removeClass("popup_loading"),
                                    p(o)
                                }
                            })
                        }
                    ...
                    v(".devvn_prod_variable .cart", o).on("change", function(e) {
                        if (i) {
                            ...
                            v.ajax({
                                ...
                                success: function(e) {
                                    e.success && i && e.data.shipping && v(".popup_quickbuy_shipping_calc", o).html(e.data.shipping),
                                    v(".popup-customer-info", o).removeClass("popup_loading"),
                                    p(o)
                                }
                            })
        ...
        function r(e) {
            ...
            t && (t = v.parseJSON(t),
            v('input[name="customer-name"]', e).val() || v('input[name="customer-name"]', e).val(t.name),
            v('input[name="customer-phone"]', e).val() || v('input[name="customer-phone"]', e).val(t.phone),
            v('input[name="customer-email"]', e).val() || v('input[name="customer-email"]', e).val(t.email),
            ...
            v(this).hasClass("devvn_buy_now_ajax") ? v.ajax({
                    ...
                    v.magnificPopup.open({
                        ...
                        callbacks: {
                            open: function() {
                                ...
                                p(e),
                                r(e),
                                "undefined" != typeof wc_add_to_cart_variation_params && v(".variations_form").each(function() {
                ...
                callbacks: {
                    open: function() {
                        a(n),
                        r(n),
                        (v("#enable_ship", n).val() || 0) && 0 < v(".popup_quickbuy_shipping_calc", n).length && v('.popup_quickbuy_shipping_calc input[name="shipping_method[0]"]', n).length <= 0 && v("#devvn_city", n).trigger("change")
                    },
                    close: function() {
                        o(n)
                    }
            ...
            if ("string" == typeof t && "0" != t && "" != t || void 0 === t)
                if (0 < v(".devvn_prod_variable .out-of-stock", a).length)
                    ...
                    u || v.ajax({
                        ...
                        beforeSend: function() {
                            u = !0,
                            v(".devvn-order-btn", a).addClass("loading")
                        },
                        success: function(e) {
                            e.success ? (c.set("quickbuy_infor", JSON.stringify(s)),
                            e.data.gotothankyou && e.data.thankyou_link ? window.location.href = e.data.thankyou_link : v(".devvn-popup-content", a).html(e.data.content)) : alert(devvn_quickbuy_array.popup_error),
                            u = !1,
        ...
        v("body").on("click", ".apply_coupon", function() {
            var t = v(this).closest(".devvn-popup-quickbuy")
              ...
              , u = 0;
            return 0 < v('button.single_add_to_cart_button[name="add-to-cart"]', t).length && (u = parseInt(v('button.single_add_to_cart_button[name="add-to-cart"]', t).val())),
            d || v.ajax({
                type: "post",
                dataType: "json",
                url: devvn_quickbuy_array.ajaxurl,
                ...
                beforeSend: function() {
                    d = !0,
                    a.addClass("popup_loading")
                },
                success: function(e) {
                    n.show(),
                    i.html("").show(),
                    e.success ? (amout_coupon = e.data.total_discount,
                    i.html(e.data.mess),
                    r.val(amout_coupon),
                    amout_coupon ? (o.show(),
                    s.html(l(amout_coupon.toFixed(0), 0, "", ".") + " " + devvn_quickbuy_array.currency_format)) : o.hide()) : i.html(e.data),
                    p(t),
                    setTimeout(function() {
                        i.html("").hide()
                    }, 2e3),
