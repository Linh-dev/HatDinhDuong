!function(t) {
    ...
    64: function(t, e, i) {
        ...
        jQuery("a.woocommerce-review-link").on("click", (function(t) {
        ...
        s.on("show_variation", (function(t, e) {
            e.hasOwnProperty("image") && e.image.thumb_src ? (jQuery(".product-gallery-slider-old .slide.first img, .sticky-add-to-cart-img, .product-thumbnails .first img, .product-gallery-slider .slide.first .zoomImg").attr("src", e.image.thumb_src).attr("srcset", ""),
            c(),
            n(),
            u()) : (jQuery(".product-thumbnails .first img").attr("src", a),
            u())
        }
        )),
        s.on("hide_variation", (function(t, e) {
            jQuery(".product-thumbnails .first img, .sticky-add-to-cart-img").attr("src", a),
            u()
        }
        )),
        ...
        jQuery(".sticky-add-to-cart-wrapper").waypoint((function(t) {
            ...
            "up" === t && (i.removeClass("sticky-add-to-cart--active"),
            e.css({
                height: "auto"
            }),
            ...
            void 0 === (o = function(t) {
                !function(t) {
                    ...
                    c.prototype._loadImage = function(e, i) {
                        ...
                        this.$zoom = t(r).on("error", t.proxy(this._onError, this)).on("load", i, t.proxy(this._onLoad, this)),
    ...
    66: function(t, e) {
        Flatsome.plugin("addQty", (function(t, e) {
            jQuery(t).on("click", ".plus, .minus", (function() {
                ...
                t.is(".plus") ? r && (r === i || i > r) ? e.val(r) : e.val((i + parseFloat(a)).toFixed(a.uxGetDecimals())) : o && (o === i || i < o) ? e.val(o) : i > 0 && e.val((i - parseFloat(a)).toFixed(a.uxGetDecimals())),
                e.trigger("change")
            }
            )),
                        ...
                        if ("" != jQuery(this).attr("data-prod")) {
                            ...
                            jQuery.post(flatsomeVars.ajaxurl, e, (function(t) {
                                ...
                                i.on("show_variation", (function(t, e) {
                                    e.image.src ? (o.attr("src", e.image.src).attr("srcset", ""),
                                    a.attr("href", e.image_link),
                                    n(),
                                    c()) : e.image_src && (o.attr("src", e.image_src).attr("srcset", ""),
                                    a.attr("href", e.image_link),
                                    n(),
                                    c())
                                }
