    ...
    void 0 === (o = "function" == typeof (n = function(t, e, i) {
        return function(t, e, i, n, o, r) {
            ...
            for (var c = 0, u = ["webkit", "moz", "ms", "o"], h = 0; h < u.length && !window.requestAnimationFrame; ++h)
                window.requestAnimationFrame = window[u[h] + "RequestAnimationFrame"],
                window.cancelAnimationFrame = window[u[h] + "CancelAnimationFrame"] || window[u[h] + "CancelRequestAnimationFrame"];
 ...
 */
    ...
    function(t, e) {
        ...
        c = "function" == typeof (u = e) ? u.call(h.exports, i, h.exports, h) : u,
        h.loaded = !0,
...
* Copyright (c) 2016 Dmitry Semenov; */
    o = [i(1)],
    void 0 === (r = "function" == typeof (n = function(t) {
        var e, i, n, o, r, s, a = function() {}, l = !!window.jQuery, c = t(window), u = function(t, i) {
            e.ev.on("mfp" + t + ".mfp", i)
        }, h = function(e, i, n, o) {
        ...
        a.prototype = {
            ...
            open: function(i) {
                ...
                if (!e.isOpen) {
                    ...
                    e.bgOverlay || (e.bgOverlay = h("bg").on("click.mfp", (function() {
                        e.close()
                    }
                    )),
        ...
        r.prototype.refresh = function() {
            ...
            t = {
                ...
                for (var a in this.waypoints[r]) {
                    var l, c, u, h, d = this.waypoints[r][a], p = d.options.offset, f = d.triggerPoint, m = 0, g = null == f;
                    ...
                    o[d.group.id] = d.group) : (!g && h || g && s.oldScroll >= d.triggerPoint) && (d.queueTrigger(s.forward),
                ...
                n.options.functionBefore.call(n.$el, n.$el, (function() {
                    if (n.enabled && null !== n.Content) {
                        ...
                        if ("hidden" !== n.Status) {
                            ...
                            if (n.$tooltip = t('<div class="tooltipster-base ' + n.options.theme + '" style="' + u + " " + h + " " + d + " " + c + '"><div class="tooltipster-content"></div></div>'),
...
, function(t, e, i) {
    ...
    function r(t) {
        ...
        function(t) {
            ...
            Math.abs(g) / (o / 2))
              , y = 0;
            if (h.top > o || h.top + r.offsetHeight < 0)
                return;
            switch (i) {
            case "backgroundImage":
                y = h.top * n,
        ...
        Flatsome.behavior("dropdown", {
            attach: function(t) {
                ...
                !i && r && jQuery(document).on("click", (function(t) {
                    null === u || u === t.target || u.has(t.target).length || (a(u),
                    c(n, "click"))
                }
                )),
