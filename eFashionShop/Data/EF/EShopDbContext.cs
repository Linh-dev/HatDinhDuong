...
namespace eFashionShop.Data.EF
{
    public class EShopDbContext : IdentityDbContext<AppUser, AppRole, int>
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Mass>().HasKey(x => x.Id);
            modelBuilder.Entity<ProductType>().HasKey(x => x.Id);
            modelBuilder.Entity<PricePerProduct>().HasKey(x => x.Id);
        ...
        public DbSet<Mass> Masss { get; set; }
        public DbSet<ProductType> ProductTypes { get; set; }
        public DbSet<PricePerProduct> PricePerProducts { get; set; }
